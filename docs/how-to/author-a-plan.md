...
3. **Resolve ambiguity by naming the deciding authority inline.** Use the authority table in [../../CLAUDE.md](../../CLAUDE.md) section 14 (CLAUDE.md section 14 is the roster). Where a decision is contested, run the relevant personas in DEBATE - they converge to ONE written ruling baked into the row, not independent parallel reviews. Red-team passes are research-only and return exact old -> new text.
